...
function Header() {
  return (
    <header className="main-header  text-white px-4 md:px-6 py-3 flex flex-wrap md:flex-nowrap items-center justify-between gap-4 shadow-md sticky top-0 z-50">
